        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col min-h-[90vh] justify-center items-center'>
...

            {
                ...
                <div className='flex w-full max-w-xl bg-neutral-500 text-sm text-white p-0.5 mt-10 rounded-full'>
                    <input onChange={e=>setInput(e.target.value)} value={input} type="text" placeholder='Describe your vision' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder-color' />
