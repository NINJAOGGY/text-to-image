...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            <motion.h1 initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4, duration: 2 }}
            ...
            <motion.button onClick={onClickHandler} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ default: { duration: 0.5 }, opacity: { delay: 0.8, duration: 1 } }}
